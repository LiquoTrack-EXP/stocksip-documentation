#### 6.2.1.6. Execution Evidence for Sprint Review 1 ####
...
Se adjuntan los enlaces para acceder al sitio web dinámico desplegado y al vídeo de demostración. El vídeo muestra el funcionamiento de cada sección del sitio web y su visualización en navegador web.
- Sitio web estático desplegado: []()
- Vídeo de ejecución: []()
