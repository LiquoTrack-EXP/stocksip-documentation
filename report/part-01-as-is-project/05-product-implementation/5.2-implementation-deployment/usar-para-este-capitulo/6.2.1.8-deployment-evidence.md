#### 6.2.1.8. Software Deployment Evidence for Sprint Review 1 ####
...
Se adjunta el enlace para acceder a la aplicación Backend desplegada: [https://stocksip-back-end.azurewebsites.net/swagger/index.html](https://stocksip-back-end.azurewebsites.net/swagger/index.html)
...
- Luego, enviamos todos los cambios realizados en este primer sprint desde la rama de desarrollo a una nueva rama de tipo release "release/1.0.0". Desde esa rama, se realizará el primer despliegue hacia la lading page.
