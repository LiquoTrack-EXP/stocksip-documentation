...
* **Paso 10: Configuración de variables de entorno**  
  Como décimo paso, una vez creado y levantado el servicio del proyecto en Azure, debemos configurar las variables de entorno necesarias para el correcto funcionamiento del backend, para esto nos dirigimos a la seccion de Configuration dentro del servicio de Azure. 
...
* **Paso 8: Agregar el APK a Firebase App Distribution**  
  Como último paso, tenemos que dirigirnos a build -> generate Signed App Bundle or APK y seleccionar para distribuir por APK, posteriormente, se debemos ingresar un nuevo key store path para la firma y el APK descargado se agrega a Firebase App Distribution. 
...
* **Paso 3: Asignar la url a la lading page**  
  Como último paso, debemos copiar la url del release y asignarla a la landing page para que los visitantes puedan descargar la aplicación móvil en Android.
...
* **Paso 1: Creación del repositorio**  
  Como primer paso, se debe crear un repositorio privado en GitHub que será el lugar donde se aloja todo lo relacionado a las versiones más estables de la aplicación móvil en Flutter.
...
* **Paso 3: Asignar la url a la lading page**  
  Como último paso, debemos copiar la url del release y asignarla a la landing page para que los visitantes puedan descargar la aplicación móvil en Flutter.
