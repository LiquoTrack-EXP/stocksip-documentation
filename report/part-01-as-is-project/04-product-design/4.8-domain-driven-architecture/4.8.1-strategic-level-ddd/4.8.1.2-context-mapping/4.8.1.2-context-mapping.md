#### 4.8.1.2. Context Mapping ###

Durante la fase de modelado basándonos en el dominio, hemos logrado identificar los siguientes contextos limitados: Inventory Management, Customer Orders, Sales Operation and Management, Profiles Management, Payments and Subscriptions, Alerts and Notifications y Identity and Access Management.
