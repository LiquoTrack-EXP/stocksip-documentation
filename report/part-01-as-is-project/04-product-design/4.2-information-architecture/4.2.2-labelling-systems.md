...
- **Inicio**: Pantalla principal desde la cual el usuario accede a los módulos más usados y visualiza un resumen general de su inventario.
- **Inventario**: Sección donde se consultan, registran y gestionan los productos disponibles.
- **Nuevo Producto**: Permite registrar un artículo nuevo de forma rápida y sencilla.
- **Alertas**: Muestra notificaciones sobre productos próximos a vencer o con stock bajo.
- **Zonas de Almacenamiento**: Permite organizar los productos según su ubicación dentro del almacén o punto de venta.
- **Reportes**: Área desde la cual se consultan resúmenes y métricas del inventario.
- **Configuración**: Sección para ajustar preferencias de la aplicación, notificaciones y datos de la cuenta.
- **Perfil Usuario**: Acceso a la información personal del usuario, con opciones para editar datos o cerrar sesión.
