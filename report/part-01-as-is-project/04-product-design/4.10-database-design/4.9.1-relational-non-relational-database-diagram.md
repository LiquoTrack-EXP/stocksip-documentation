...
No se diagrama la base de datos relacional, ya que se ha decidido usar una base de datos no relacional para el contexto de inventarios. Siendo correspondiente a nuestra lista de requisitos no funcionales.