...
El diagrama de despligue en la arquitectura de software muestra cómo los contenedores del sistema se implementan en la infraestructura física o en la nube, incluyendo nodos, redes y otros componentes de infraestructura.

Para StockSip, el diagrama de despliegue incluye los siguientes nodos y su configuración:

<img src="https://i.imgur.com/jPcORN6.png" alt="deployment-diagram" style="width: 100%; height: auto;"/>
